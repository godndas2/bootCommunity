...
//        winnerService.saveAll(List.of(winner1, winner2));
        winnerService.saveAll(Arrays.asList(winner1, winner2));
    }
...
//            winnerService.saveAll(List.of(winner1, winner1));
            winnerService.saveAll(Arrays.asList(winner1, winner1));
//            winnerService.saveAll(List.of(winner1, winner2));
            winnerService.saveAll(Arrays.asList(winner1, winner2));
        });
...
//            winnerService.saveAllNotSupported(List.of(winner1, winner1));
        	winnerService.saveAllNotSupported(Arrays.asList(winner1, winner1));
//            winnerService.saveAllNotSupported(List.of(winner1, winner2, winner3));
        	winnerService.saveAllNotSupported(Arrays.asList(winner1, winner2, winner3));
        });
        assertEquals(DataIntegrityViolationException.class, exception.getClass());
    }
...
//            winnerService.saveAllNested(List.of(winner1, winner1));
            winnerService.saveAllNested(Arrays.asList(winner1, winner1));
//            winnerService.saveAllNested(List.of(winner1, winner2, winner3));
            winnerService.saveAllNested(Arrays.asList(winner1, winner2, winner3));
        });
        assertEquals(DataIntegrityViolationException.class, exception.getClass());
    }
...
//            winnerService.innerSave(List.of(winner1, winner1));
            winnerService.innerSave(Arrays.asList(winner1, winner1));
//            winnerService.innerSave(List.of(winner1, winner2, winner3));
            winnerService.innerSave(Arrays.asList(winner1, winner2, winner3));
        });
        assertEquals(DataIntegrityViolationException.class, exception.getClass());
    }
...
//            winnerService.innerSaveNew(List.of(winner1, winner1));
            winnerService.innerSaveNew(Arrays.asList(winner1, winner1));
//            winnerService.innerSaveNew(List.of(winner1, winner2, winner3));
            winnerService.innerSaveNew(Arrays.asList(winner1, winner2, winner3));
        });
        assertEquals(DataIntegrityViolationException.class, exception.getClass());
    }
...
//            winnerService.innerNotSupported(List.of(winner1, winner1));
            winnerService.innerNotSupported(Arrays.asList(winner1, winner1));
//            winnerService.innerNotSupported(List.of(winner1, winner2, winner3));
            winnerService.innerNotSupported(Arrays.asList(winner1, winner2, winner3));
        });
        assertEquals(DataIntegrityViolationException.class, exception.getClass());
    }
}
